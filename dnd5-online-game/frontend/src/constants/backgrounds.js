export const BACKGROUNDS = [
  ...
  { value: 'criminal', label: 'Преступник', labelEn: 'Criminal', skills: ['deception', 'stealth'] },
  { value: 'entertainer', label: 'Артист', labelEn: 'Entertainer', skills: ['acrobatics', 'performance'] },
